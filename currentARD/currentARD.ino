...
//Constants
long interval = 7000; //CHANGE THIS TO CHANGE POD TIMING
...
const int servoPin5 = 6;//control food servo in hunting chamber
const int pelletPin = 7;//to FED3

const int ard_pi_1 = 44;//reports MODE=2 to Pi 
const int ard_pi_2 = 45;//reports trial start to Pi
const int ard_pi_3 = 46;//reports
const int ard_pi_4 = 47;//reports food pod entry to Pi
const int ard_pi_5 = 48;// reports running wheel pod entry to Pi
...
const int pi_ard_1 = 33;//receive RFID command from Pi 
const int pi_ard_2 = 34;//receive weight decision from Pi
const int pi_ard_3 = 35;//receive weight decision from Pi (when animal is done)
...
void loop()
{
  ...
  if (MODE==4)//open doors back to cage
  { 
      servo2.write(CLOSE_DOOR2); 
      delay(100);
      servo1.write(OPEN_DOOR1);
