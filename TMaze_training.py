...
def RFID_prevent_previous_check(animaltag, previous_animal, tt = trial_type):
    """
    ...
    if previous_animal ==  "first_trial":
        print("This is the first trial of the training block. Any animal is accepted.")
        print("Entry allowed")
        entry_flag = True
        return entry_flag
    
    if previous_animal != animaltag:
        print(previous_animal)
        print(animaltag)
        print("Animal is not the same as previous trial")
        print("Entry allowed")
        entry_flag = True
        return entry_flag
    ...
    if previous_animal == animaltag:
        print(previous_animal)
        print(animaltag)
        print("Animal is the same as previous trial")
...
while True:
    ...
    while True:
        if MODE == 1:
            ...
            entry_flag = RFID_prevent_previous_check(animaltag, previous_animal)
        ...
        if MODE == 2 and GPIO.input(ard_pi_1): 
            ...
            while True:
                ...
                animaltag = RFID_datacheck(clean_tag)
                same_animal = RFID_prevent_previous_check(animaltag, previous_animal)
                if not same_animal:
                    MODE = 0
                    break
